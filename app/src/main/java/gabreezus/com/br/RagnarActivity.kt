...
class RagnarActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Log.d("Aviso!", "Criando... RagnarActivity")
    ...
    private fun redireciona(op: Int) {
        ...
        val bundle = Bundle()
        val frase = "Você chegou neste personagem através do personagem Ragnar Lothbrok"
        with(bundle) {
    ...
    override fun onStart() {
        super.onStart()
        Log.d("Aviso!", "Iniciando... RagnarActivity")
    }

    override fun onResume() {
        super.onResume()
        Log.d("Aviso!", "Resumindo... RagnarActivity")
    }

    override fun onRestart() {
        super.onRestart()
        Log.d("Aviso!", "Reiniciando... RagnarActivity")
    }

    override fun onStop() {
        super.onStop()
        Log.d("Aviso!", "Parando... RagnarActivity")
    }

    override fun onDestroy() {
        super.onDestroy()
        Log.d("Aviso!", "Destruindo... RagnarActivity")
    }
